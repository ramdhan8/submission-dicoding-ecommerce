...
[E-Commerce Data Dashboard Streamlit App](https://submission-dicoding-ecommerce-nurrahmatramdhan.streamlit.app/)
...
```
git clone https://github.com/ramdhan8/submission-dicoding-ecommerce.git
```
2. Go to the project directory
```
cd submission-dicoding-ecommerce
```
